...
Revision ID: 52d4759e0d8b
Revises: 
Create Date: 2024-01-25 19:29:31.117750
...
def upgrade():
    ...
    op.create_table('tenant',
        ...
        sa.Column('email', sqlalchemy_utils_types.email.EmailType(length=255), nullable=True),
    ...
    with op.batch_alter_table('rent', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_rent_lease_id'), ['lease_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('rent', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_rent_lease_id'))
